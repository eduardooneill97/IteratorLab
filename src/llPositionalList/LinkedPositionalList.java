...
public class LinkedPositionalList<E> implements PositionalList<E> {
	...
	private static class DNode<E> implements Position<E> { 
		...
		public DNode(E element, LinkedPositionalList<E> list) {
	...
	public LinkedPositionalList(PLIteratorMaker<E> maker){
		this();
		this.iteratorMaker = maker;
	}
	...
	private class ElementIterator implements Iterator<E> { 
		Iterator<Position<E>> posIterator = LinkedPositionalList.this.iteratorMaker.makeIterator(LinkedPositionalList.this);
